...
class DataLoader(object) :
    ...
    def __init__(self):
        self.num_classes = 10
        self.url = 'https://commondatastorage.googleapis.com/books1000/'
    ...
    def exec(self):
        ...
        train_filename = self.maybe_download('notMNIST_large.tar.gz', 247336696)
        test_filename = self.maybe_download('notMNIST_small.tar.gz', 8458043)

        np.random.seed(133)

        train_folders = self.maybe_extract(train_filename)
        test_folders = self.maybe_extract(test_filename)
